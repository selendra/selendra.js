import { SelendraEvmTX } from '@selendra/eth-transactions';
...
export declare type Signature = 'Ethereum' | 'SelendraEip712' | 'Substrate';
...
export declare abstract class BaseProvider extends AbstractProvider {
    ...
    constructor({ safeMode, localMode, richMode, verbose, subqlUrl, maxBlockCacheSize, storageCacheSize, healthCheckBlockDistance }?: BaseProviderOptions);
    startSubscription: () => Promise<any>;
    setApi: (api: ApiPromise) => void;
    queryStorage: <T = any>(module: `${string}.${string}`, args: any[], _blockTag?: BlockTag | Promise<BlockTag> | Eip1898BlockTag | undefined) => Promise<T>;
    get api(): ApiPromise;
    ...
    getBalance: (addressOrName: string | Promise<string>, _blockTag?: BlockTag | Promise<BlockTag> | Eip1898BlockTag | undefined) => Promise<BigNumber>;
    getTransactionCount: (addressOrName: string | Promise<string>, blockTag?: BlockTag | Promise<BlockTag> | Eip1898BlockTag | undefined) => Promise<number>;
    ...
    getCode: (addressOrName: string | Promise<string>, _blockTag?: BlockTag | Promise<BlockTag> | Eip1898BlockTag | undefined) => Promise<string>;
    call: (transaction: Deferrable<TransactionRequest>, _blockTag?: BlockTag | Promise<BlockTag> | Eip1898BlockTag | undefined) => Promise<string>;
    getStorageAt: (addressOrName: string | Promise<string>, position: BigNumberish | Promise<BigNumberish>, _blockTag?: BlockTag | Promise<BlockTag> | Eip1898BlockTag | undefined) => Promise<string>;
    ...
    queryAccountInfo: (addressOrName: string | Promise<string>, _blockTag?: BlockTag | Promise<BlockTag> | Eip1898BlockTag | undefined) => Promise<Option<EvmAccountInfo>>;
    ...
    _getSubstrateGasParams: (ethTx: SelendraEvmTX) => {
        gasLimit: bigint;
        storageLimit: bigint;
        validUntil: bigint;
        tip: bigint;
    ...
    prepareTransaction: (rawTx: string) => Promise<{
        ...
        transaction: SelendraEvmTX;
    }>;
    sendRawTransaction: (rawTx: string) => Promise<string>;
    sendTransaction: (signedTransaction: string | Promise<string>) => Promise<TransactionResponse>;
    _wrapTransaction: (tx: SelendraEvmTX, hash: string, startBlock: number, startBlockHash: string) => Promise<TransactionResponse>;
    ...
    getTransactionReceiptAtBlock: (hashOrNumber: number | string | Promise<string>, _blockTag: BlockTag | Promise<BlockTag> | Eip1898BlockTag) => Promise<TransactionReceipt>;
