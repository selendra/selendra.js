...
exports.parseBlockTag = exports.nativeToEthDecimal = exports.runWithTiming = exports.getHealthResult = exports.runWithRetries = exports.isEVMExtrinsic = exports.sleep = void 0;
...
const runWithRetries = async (fn, args = [], maxRetries = 20, interval = 1000) => {
    let res;
    let tries = 0;
...
const getHealthResult = ({ indexerMeta, cacheInfo, curFinalizedHeight, ethCallTiming }) => {
    ...
    const msg = [];
    /* --------------- cache --------------- */
    const maxCachedBlocks = (cacheInfo === null || cacheInfo === void 0 ? void 0 : cacheInfo.maxCachedBlocks) || 0;
    ...
    const lastProcessedTimestamp = parseInt((indexerMeta === null || indexerMeta === void 0 ? void 0 : indexerMeta.lastProcessedTimestamp) || '0');
    const lastProcessedHeight = (indexerMeta === null || indexerMeta === void 0 ? void 0 : indexerMeta.lastProcessedHeight) || 0;
    const targetHeight = (indexerMeta === null || indexerMeta === void 0 ? void 0 : indexerMeta.targetHeight) || 0;
    const indexerHealthy = (indexerMeta === null || indexerMeta === void 0 ? void 0 : indexerMeta.indexerHealthy) || false;
