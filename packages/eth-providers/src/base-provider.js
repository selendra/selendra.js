...
const eth_transactions_1 = require("@selendra/eth-transactions");
...
class BaseProvider extends abstract_provider_1.Provider {
    constructor({ safeMode = false, localMode = false, richMode = false, verbose = false, subqlUrl, maxBlockCacheSize = 200, storageCacheSize = 5000, healthCheckBlockDistance = 100 } = {}) {
        super();
        ...
        this.startSubscription = async () => {
            ...
            subscriptionMethod(async (header) => {
                ...
                if (((_a = this._listeners[NEW_HEADS]) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                ...
                if (((_b = this._listeners[NEW_LOGS]) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                    ...
                    (_c = this._listeners[NEW_LOGS]) === null || _c === void 0 ? void 0 : _c.forEach(({ cb, filter }) => {
            ...
            this.api.rpc.state.subscribeRuntimeVersion((runtime) => {
                ...
                if (!this.runtimeVersion || this.runtimeVersion === version) {
                    ...
                    utils_1.logger.warn(`runtime version changed: ${this.runtimeVersion} => ${version}, shutting down myself... good bye 👋`);
        ...
        this.queryStorage = async (module, args, _blockTag) => {
            const blockTag = await this._ensureSafeModeBlockTagFinalization(await (0, utils_1.parseBlockTag)(_blockTag));
        ...
        this.getTransactionCount = async (addressOrName, blockTag) => {
            return this.getEvmTransactionCount(addressOrName, await (0, utils_1.parseBlockTag)(blockTag));
        };
        // TODO: test pending
        ...
        this.call = async (transaction, _blockTag) => {
            ...
            const callRequest = {
                ...
                gasLimit: (_a = resolved.transaction.gasLimit) === null || _a === void 0 ? void 0 : _a.toBigInt(),
                storageLimit: undefined,
                value: (_b = resolved.transaction.value) === null || _b === void 0 ? void 0 : _b.toBigInt(),
        ...
        this.getEthResources = async (transaction, { gasLimit, storageLimit, validUntil } = {}) => {
            if (!gasLimit || !storageLimit) {
                ...
                gasLimit = gasLimit !== null && gasLimit !== void 0 ? gasLimit : gas;
                storageLimit = storageLimit !== null && storageLimit !== void 0 ? storageLimit : storage;
            }
            if (!validUntil) {
        ...
        this.estimateResources = async (transaction) => {
            ...
            const accessList = ((_a = ethTx.accessList) === null || _a === void 0 ? void 0 : _a.map(({ address, storageKeys }) => [address, storageKeys])) || [];
            const extrinsic = !to
                ? this.api.tx.evm.create(data, value === null || value === void 0 ? void 0 : value.toBigInt(), consts_1.U64MAX.toBigInt(), // gas_limit u64::max
                consts_1.U32MAX.toBigInt(), // storage_limit u32::max
                // @ts-ignore @TODO fix type
                accessList)
                : this.api.tx.evm.call(to, data, value === null || value === void 0 ? void 0 : value.toBigInt(), consts_1.U64MAX.toBigInt(), // gas_limit u64::max
                consts_1.U32MAX.toBigInt(), // storage_limit u32::max
                // @ts-ignore @TODO fix type
                accessList);
        ...
        this._getSubstrateGasParams = (ethTx) => {
            ...
            if (ethTx.type === 96) {
                // EIP-712 transaction
                const _storageLimit = (_a = ethTx.storageLimit) === null || _a === void 0 ? void 0 : _a.toString();
                const _validUntil = (_b = ethTx.validUntil) === null || _b === void 0 ? void 0 : _b.toString();
                const _tip = (_c = ethTx.tip) === null || _c === void 0 ? void 0 : _c.toString();
                if (!_storageLimit) {
                ...
                const _getErrInfo = () => {
                    ...
                    return ({
                        ...
                        txGasPrice: (_a = ethTx.gasPrice) === null || _a === void 0 ? void 0 : _a.toBigInt(),
                        maxPriorityFeePerGas: (_b = ethTx.maxPriorityFeePerGas) === null || _b === void 0 ? void 0 : _b.toBigInt(),
                        maxFeePerGas: (_c = ethTx.maxFeePerGas) === null || _c === void 0 ? void 0 : _c.toBigInt(),
                        txFeePerGas,
                ...
                try {
                    ...
                    tip = (((_d = ethTx.maxPriorityFeePerGas) === null || _d === void 0 ? void 0 : _d.toBigInt()) || 0n) * gasLimit;
                }
                catch {
            ...
            const accessList = (_e = ethTx.accessList) === null || _e === void 0 ? void 0 : _e.map((set) => [set.address, set.storageKeys]);
            return {
                gasLimit,
                storageLimit,
                validUntil,
        ...
        this.sendTransaction = async (signedTransaction) => {
            ...
            try {
                ...
                for (const pattern of consts_1.ERROR_PATTERN) {
                    const match = (((_a = error.toString) === null || _a === void 0 ? void 0 : _a.call(error)) || '').match(pattern);
                    if (match) {
        ...
        this._getTxReceiptFromCache = async (txHash) => {
            var _a;
            const targetBlockNumber = (_a = this._cache) === null || _a === void 0 ? void 0 : _a.getBlockNumber(txHash);
        ...
        this._getMinedTXReceipt = async (txHash) => {
            ...
            if (txFromCache)
                return txFromCache;
            const txFromSubql = await ((_a = this.subql) === null || _a === void 0 ? void 0 : _a.getTxReceiptByHash(txHash));
            ...
            if (res) {
                ...
                res.effectiveGasPrice = ethers_1.BigNumber.from(res.effectiveGasPrice);
            }
            return res;
        };
        // Queries
        ...
        this.getTransactionByHash = async (txHash) => {
            ...
            const tx = this.localMode
                ? await (0, utils_1.runWithRetries)(this._getMinedTXReceipt.bind(this), [txHash])
        ...
        this.getLogs = async (rawFilter) => {
            ...
            if (blockHash) {
                ...
                const fromBlockNumber = await this._getBlockNumberFromTag(fromBlock !== null && fromBlock !== void 0 ? fromBlock : 'latest');
                const toBlockNumber = await this._getBlockNumberFromTag(toBlock !== null && toBlock !== void 0 ? toBlock : 'latest');
            ...
            const filteredLogs = subqlLogs.filter((log) => (0, utils_1.filterLogByTopics)(log, filter.topics));
            return filteredLogs.map((log) => this.formatter.filterLog(log));
        };
        this.getIndexerMetadata = async () => {
            var _a;
            return await ((_a = this.subql) === null || _a === void 0 ? void 0 : _a.getIndexerMetadata());
        };
        this.getCachInfo = () => { var _a; return (_a = this._cache) === null || _a === void 0 ? void 0 : _a._inspect(); };
        ...
        this.removeEventListener = (id) => {
            ALL_EVENTS.forEach((e) => {
                var _a;
                this._listeners[e] = (_a = this._listeners[e]) === null || _a === void 0 ? void 0 : _a.filter((l) => l.id !== id);
            });
            return true;
        };
        ...
        richMode && utils_1.logger.warn(consts_1.RICH_MODE_WARNING_MSG);
