    ...
    interface RpcInterface {
        ...
        dex: {
            ...
            getSupplyAmount: AugmentedRpc<(supplyCurrencyId: CurrencyId | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array, targetCurrencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array, targetCurrencyAmount: BalanceRequest | {
                amount?: any;
            } | string | Uint8Array) => Observable<BalanceWrapper>>;
            /**
             * Get target amount
             **/
            getTargetAmount: AugmentedRpc<(supplyCurrencyId: CurrencyId | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array, supplyCurrencyAmount: BalanceRequest | {
                amount?: any;
            } | string | Uint8Array) => Observable<BalanceWrapper>>;
        };
        engine: {
        ...
        tokens: {
             ...
             **/
            queryExistentialDeposit: AugmentedRpc<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<NumberOrHex>>;
        };
        web3: {
            /**
