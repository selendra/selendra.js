...
import type { PalletBalanceOf } from '@selendra/types/interfaces/accounts';
import type { CollateralAuctionItem, DebitAuctionItem, SurplusAuctionItem } from '@selendra/types/interfaces/auctionManager';
import type { ChangeBalance, ChangeOptionRate, ChangeOptionRatio, LiquidationStrategy, OptionRate, OptionRatio, RiskManagementParams } from '@selendra/types/interfaces/cdpEngine';
import type { CandidateInfoOf } from '@selendra/types/interfaces/collatorSelection';
import type { BalanceRequest, BalanceWrapper, TradingPairProvisionParameters, TradingPairStatus } from '@selendra/types/interfaces/dex';
import type { CallRequest, CodeInfo, Erc20Info, EstimateResourcesResponse, EvmAccountInfo, EvmAddress, EvmContractInfo } from '@selendra/types/interfaces/evm';
import type { PoolId, PoolIdV0 } from '@selendra/types/interfaces/incentives';
import type { Position } from '@selendra/types/interfaces/loans';
import type { Attributes, CID, ClassData, ClassIdOf, ClassInfoOf, NFTBalance, NFTBalanceOf, NFTClassId, Properties, TokenData, TokenId, TokenIdOf, TokenInfoOf } from '@selendra/types/interfaces/nft';
import type { Amount, AmountOf, AuctionId, AuctionIdOf, AuthoritysOriginId, ChainBridgeChainId, CurrencyId, CurrencyIdOf, DexShare, NumberOrHex, SelendraAssetMetadata, SelendraDataProviderId, TokenSymbol, TradingPair } from '@selendra/types/interfaces/primitives';
import type { DestAddress, PublicKey } from '@selendra/types/interfaces/renvmBridge';
import type { AccountId, AccountId20, AccountId32, AccountIdOf, AccountIndex, Address, AsOriginId, AssetId, AtLeast64BitUnsigned, Balance, BalanceOf, Block, BlockNumber, BlockNumberFor, BlockNumberOf, Call, CallHash, CallHashOf, ChangesTrieConfiguration, ChangesTrieSignal, CodecHash, Consensus, ConsensusEngineId, CrateVersion, Digest, DigestItem, EncodedJustification, ExtrinsicsWeight, Fixed128, Fixed64, FixedI128, FixedI64, FixedU128, FixedU64, H1024, H128, H160, H2048, H256, H32, H512, H64, Hash, Header, HeaderPartial, I32F32, Index, IndicesLookupSource, Justification, Justifications, KeyTypeId, KeyValue, LockIdentifier, LookupSource, LookupTarget, ModuleId, Moment, MultiAddress, MultiSigner, OpaqueCall, OracleKey, OracleValue, Origin, OriginCaller, PalletId, PalletVersion, PalletsOrigin, Pays, PerU16, Perbill, Percent, Permill, Perquintill, Phantom, PhantomData, PreRuntime, RelayChainBlockNumberOf, Releases, RuntimeDbWeight, Seal, SealV0, SignedBlock, SignedBlockWithJustification, SignedBlockWithJustifications, Slot, StableAssetPoolId, StorageData, StorageProof, TransactionInfo, TransactionPriority, TransactionStorageProof, U32F32, ValidatorId, ValidatorIdOf, Weight, WeightMultiplier } from '@selendra/types/interfaces/runtime';
import type { ExchangeRate, Rate, Ratio } from '@selendra/types/interfaces/support';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    SeedOf: SeedOf;
    SelendraAssetMetadata: SelendraAssetMetadata;
    SelendraDataProviderId: SelendraDataProviderId;
