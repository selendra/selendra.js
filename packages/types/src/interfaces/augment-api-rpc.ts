...
import type { BalanceRequest, BalanceWrapper } from '@selendra/types/interfaces/dex';
import type { CallRequest, EstimateResourcesResponse } from '@selendra/types/interfaces/evm';
import type { CurrencyId, NumberOrHex } from '@selendra/types/interfaces/primitives';
import type { AccountId, BlockNumber, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, OracleKey, SignedBlock, StorageData } from '@selendra/types/interfaces/runtime';
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  export interface RpcInterface {
    ...
    oracle: {
       ...
       **/
      getValue: AugmentedRpc<(providerId: RpcDataProviderId | string, key: OracleKey | { Token: any } | { DEXShare: any } | { ERC20: any } | { StableAssetPoolToken: any } | { ForeignAsset: any } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<Option<TimestampedValue>>>;
    };
    payment: {
      /**
    ...
    tokens: {
       ...
       **/
      queryExistentialDeposit: AugmentedRpc<(currencyId: CurrencyId | { Token: any } | { DEXShare: any } | { ERC20: any } | { StableAssetPoolToken: any } | { ForeignAsset: any } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<NumberOrHex>>;
    };
    web3: {
      /**
