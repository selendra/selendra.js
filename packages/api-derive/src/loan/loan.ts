...
import { AccountId, Position } from '@selendra/types/interfaces';
...
export function loan(
  instanceId: string,
  api: ApiInterfaceRx
): (account: AccountId | string, currency: SelendraPrimitivesCurrencyCurrencyId) => Observable<DerivedUserLoan> {
  return memo(instanceId, (account: AccountId | string, currency: SelendraPrimitivesCurrencyCurrencyId) =>
