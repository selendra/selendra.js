...
```
rush update
rush build -t @selendra/eth-rpc-adapter
```
...
|--------------------|-----------------|---------------------|---------------------------------------------------------------------------------------------------------|
| ENDPOINT_URL       | -e, --endpoint           | ws://localhost:9944 | selendra node url                                                                                          |
...
| LOCAL_MODE         | -l, --local              | 0                   | enable this mode when testing with locally running selendra                                              |
